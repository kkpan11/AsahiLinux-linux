...
static const struct dcp_method_entry dcp_methods[dcpep_num_methods] = {
	...
	IOMFB_METHOD("A377", dcpep_set_create_dfb),
	IOMFB_METHOD("A378", iomfbep_a358_vi_set_temperature_hint),
	IOMFB_METHOD("A401", dcpep_start_signal),
	IOMFB_METHOD("A406", dcpep_swap_start),
	IOMFB_METHOD("A407", dcpep_swap_submit),
	IOMFB_METHOD("A409", dcpep_set_display_device),
	IOMFB_METHOD("A410", dcpep_is_main_display),
	IOMFB_METHOD("A411", dcpep_set_digital_out_mode),
	IOMFB_METHOD("A421", iomfbep_set_matrix),
	IOMFB_METHOD("A425", iomfbep_get_color_remap_mode),
	IOMFB_METHOD("A440", dcpep_set_parameter_dcp),
	IOMFB_METHOD("A444", dcpep_create_default_fb),
	IOMFB_METHOD("A443", dcpep_enable_disable_video_power_savings),
	IOMFB_METHOD("A455", dcpep_first_client_open),
	...
	//IOMFB_METHOD("A471", dcpep_update_dfb_surface),
	IOMFB_METHOD("A472", dcpep_set_power_state),
};

#define DCP_FW v14_7_0
#define DCP_FW_VER DCP_FW_VERSION(14, 7, 0)
...
static const iomfb_cb_handler cb_handlers[IOMFB_MAX_CB] = {
	...
	[121] = dcpep_cb_boot_1, /* is_dark_boot */
	...
	//[582] = trampoline_create_dfb_surface, /* create_default_fb_surface */
	[582] = trampoline_true,
